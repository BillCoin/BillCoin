...
const string strMessageMagic = "BillCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 840000 * COIN; return nSubsidy; 
	}
	...
	else if(pindexBest->nHeight < 300001)
	{
        nSubsidy = 100 * COIN;
    }
	else if(pindexBest->nHeight < 400001)
	{
        nSubsidy = 60 * COIN;
    }
	else if(pindexBest->nHeight < 550001)
	{
        nSubsidy = 30 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BillCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bill is launching BillCoin";
        CTransaction txNew;
        txNew.nTime = 1458755744;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("2028021bb9e3ae613d5c3a01f4750e18e33b919a37915f2df0d38170e9048eae");
